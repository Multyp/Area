...
export const applet: Applet = {
  name: 'twitch_stream_start_notify_outlook',
  title: 'Notify on Microsoft Outlook when you start streaming',
  description: 'Notify a Microsoft Outlook when you start streaming.',
